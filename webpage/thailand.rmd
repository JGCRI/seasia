...
```{r national final energy consumption by sector 1, fig.dim=c(9,4), fig.cap="**Figure 10.2.1.3. National total final energy by sector from local data (left) and GCAM output (right) from 2005 to 2020. Local data source: [Energy Efficiency Plan 2018](https://www.dede.go.th/ewt_w3c/ewt_dl_link.php?filename=index&nid=54495)**"}
