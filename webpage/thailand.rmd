...
pop_inputs <- read.csv("data/Thailand/inputs/socioeconomics/thailand_bangkok_nonthaburi_samutprakan_pop.csv")
...
gdp_inputs_baht <- read.csv("data/Thailand/inputs/socioeconomics/baht_thailand_bangkok_nonthaburi_samutprakan_gdp.csv")
gdp_growth_baht <- read.csv("data/Thailand/inputs/socioeconomics/baht_gdp_growth.csv")
...
pcgdp_inputs_baht <- read.csv("data/Thailand/inputs/socioeconomics/baht_thailand_bangkok_nonthaburi_samutprakan_pcgdp.csv")
...
```{r gcam enduse sector groups, echo = F}
...
```{r local electricity sector groups, echo = F}
...
```{r national electricity consumption data prep, results = "hide", echo=FALSE, out.width="70%", fig.align='center', message = FALSE}
# read in local data
local_national_elec_consump <- read.csv(
  "data/Thailand/outputs/initial_diagnostics/local_national_elec_consump.csv"
)

# read in and process gcam data
gcam_elec_consump_sector <- process_gcam_data(
  read.csv("data/Thailand/outputs/initial_diagnostics/queryoutall_elec_consump_sector.csv", 
...
The figures below show the national total electricity consumption as reported by MEA, PEA, and EGAT from 2011 to 2020 (red) and as calculated by GCAM from 2005 to 2100 (blue). The plot on the right shows only data from 2011 to 2020, the period during which local data are available.

```{r national consumption total charts, results = "hide", echo=FALSE, fig.align='center', message = FALSE, out.width="85%"}
...
The figure below shows national electricity consumption by sector as reported by MEA, PEA, and EGAT (left) and as calculated by GCAM (right) for 2015 and 2020. 

```{r national consumption by sector 1, results = "hide", echo=FALSE, out.width="100%", fig.align='center', message = FALSE}
...
The figure below shows the GCAM output for national electricity consumption by sector through 2100.

```{r national consumption by sector 2, results = "hide", echo=FALSE, out.width="100%", fig.align='center', message = FALSE}
...
```{r total consumption MEA area data prep, results = "hide", echo=FALSE, out.width="70%", fig.align='center', message = FALSE}
# read in local data
local_mea_elec_consump <- tidyr::drop_na(read.csv(
  "data/Thailand/outputs/initial_diagnostics/local_mea_area_elec_consump.csv"
))
...
The figures below show the total electricity consumption within the MEA service area (Bangkok, Nonthaburi, and Samut Prakan) as reported by MEA from 2011 to 2020 (red) and as calculated by GCAM from 2005 to 2100 (blue). The plot on the right shows only data from 2011 to 2020, the period during which local data are available.

```{r consumption MEA area total charts, results = "hide", echo=FALSE, out.width="100%", fig.align='center', message = FALSE}
...
The figure below shows electricity consumption by sector in the MEA service area as reported by MEA (left) and as calculated by GCAM (right) for 2015 and 2020. 

```{r consumption by sector MEA area chart 1, results = "hide", echo=FALSE, out.width="100%", fig.align='center', message = FALSE}
...
The figure below shows the GCAM output for electricity consumption by sector in the MEA service area through 2100.

``` {r consumption by sector MEA area chart 2, results = "hide", echo=FALSE, out.width="100%", fig.align='center', message = FALSE}
# chart of electricity consumption by sector (gcam, 2000 to 2100)
elec_consump_sector_gcam_chart <- rchart::chart(dplyr::filter(
  all_elec_consump_sector_mea, scenario == "Ref", year >= 2000),
  save = F, aspect_ratio = 0.5)
...
```{r national final energy data prep, results = "hide", echo=FALSE, out.width="70%", fig.align='center', message = FALSE}

######## by fuel ########

# read in and process gcam data
gcam_final_energy_fuel <- process_gcam_data(
  read.csv("data/Thailand/outputs/initial_diagnostics/queryoutall_final_energy_consump_fuel_sector.csv", skip = 1, check.names = F),
  input, sector
)
...
local_national_final_energy_fuel <- read.csv(
  "data/Thailand/outputs/initial_diagnostics/local_national_final_energy_fuel.csv",
  check.names = F
)
...
```{r national final energy total charts, results = "hide", echo=FALSE, out.width="100%", fig.align='center', message = FALSE}
...
# total final energy, 2000 to 2100
...
```{r national final energy consumption by fuel charts, results = "hide", echo=FALSE, out.width="100%", fig.align='center', message = FALSE}
...
final_energy_fuel_chart_gcam <- rchart::chart(dplyr::filter(
  all_national_final_energy_fuel, year >= 2000, scenario == "Ref"),
  save = F, break_interval = 3)
...
```{r national final energy consumption by sector charts, results = "hide", echo=FALSE, out.width="100%", fig.align='center', message = FALSE}

# 2000 to 2100, gcam only (no local data available)
gcam_final_energy_agg_sector_chart <- rchart::chart(
  dplyr::filter(gcam_final_energy_agg_sector, year > 2000),
  save = F
)
...
```{r national co2 emissions data prep, results = "hide", echo=FALSE, out.width="100%", fig.align='center', message = FALSE}
C_to_CO2 <- 44/12

# read in and process gcam data
gcam_co2_emissions_sector <- dplyr::mutate(
  process_gcam_data(
  read.csv("data/Thailand/outputs/initial_diagnostics/queryoutall_co2_emissions_sector.csv", skip = 1, check.names = F),
  sector), value = value * C_to_CO2, Units = "MTCO2"
)
...
local_national_co2_emissions_sector <- dplyr::mutate(
  read.csv(
  "data/Thailand/outputs/initial_diagnostics/local_national_co2_emissions_sector.csv",
  check.names = F)
)
...
```{r national co2 emissions total plots, results = "hide", echo=FALSE, out.width="70%", fig.align='center', message = FALSE}
...
national_co2_emissions_plot_gcam <- rchart::chart(dplyr::filter(
  all_national_co2_emissions_sector, year >= 2000),
  save = F)
...
```{r national co2 emissions by sector plots, results = "hide", echo=FALSE, out.width="70%", fig.align='center', message = FALSE}
...
<!-- ```{r transportation groups, echo = F} -->
<!-- road_group <- c("2W and 3W", "Car", "Large Car and Truck", "Medium truck", "road", "4W", "Cycle", "Mini Car", "Bus", "Heavy truck", "Light truck", "LDV") -->
...
<!-- ```{r transportation data prep, echo = F} -->
<!-- # read in local data -->
<!-- local_national_transport_output <- read.csv( -->
<!--   "data/Thailand/outputs/initial_diagnostics/local_national_transport_output.csv", -->
<!--   check.names = F -->
<!-- ) -->

<!-- # read in and process gcam data -->
<!-- gcam_transport_output_subsector <- process_gcam_data( -->
<!--   read.csv("data/Thailand/outputs/initial_diagnostics/queryoutall_transport_output_tech.csv", skip = 1, check.names = F), -->
<!--   subsector, sector, technology -->
<!-- ) -->
