...
The plot below shows per capita GDP/GPP from 1990 to 2100 for each region.

```{r historical & future trends pcgdp baht, fig.dim=c(8,4), fig.cap="**Figure 9.1.3.3. Per capita GDP/GPP through 2100 in each region**"}
