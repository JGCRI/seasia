...
``` {r pop-plot, echo = FALSE, fig.dim = c(8,4), eval = FALSE, fig.cap="Figure 9.1.1.1. **Historical and future projected population in Malaysia and Kuala Lumpur**"}
# Population
...
``` {r gdp, echo = FALSE, eval = FALSE, fig.dim = c(8,4), fig.cap="Figure 9.1.2.1. **Historical and future projected GDP in Malaysia and Kuala Lumpur**"}
# GDP
...
``` {r gdp_pc, echo = FALSE, eval = FALSE, fig.dim = c(8,4), fig.cap="Figure 9.1.3.1. **Historical and future projected GDP per capita in Malaysia and Kuala Lumpur**"}
