...
Policies modeled include:

* High efficiency lighting and appliances in buildings
* Building envelope efficiency improvements
* Hydrogen in industry
* Industrial energy efficiency
* Transportation public-private modal shift
* Greater use of electric vehicles
* Renewable energy
* Coal phase-out

For greater details on implementation, please reference the [Modeling - Malaysia page](modeling_malaysia.html#4_Policies).
