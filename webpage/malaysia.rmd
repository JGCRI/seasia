...
<td>Population</td>
<td>
<span>- Malaysia population for the medium variant projection</span><br/>
<span>- Growth rates for Bangkok were used for Kuala Lumpur</span>
</td>
<td>
<span>- Malaysia: [United Nations](https://population.un.org/wpp/)</span><br/>
<span>- Kuala Lumpur 1971-2017: [United Nations]()</span><br/>
<span>- Kuala Lumpur 2017-2021: [Department of Statistics Malaysia](https://www.dosm.gov.my/v1/index.php?r=column/cone&menu_id=bjRlZXVGdnBueDJKY1BPWEFPRlhIdz09)</span>
</td>
</tr>
...
The plot below shows historical and future projected populations in Malaysia and Kuala Lumpur comparing the data sources above to the GCAM reference scenario. As mentioned above, population growth rates in Kuala Lumpur were assumed to be on par with Bangkok, Thailand. Please reference the <a href=thailand.html#9_Inputs> data sources for Thailand </a> for more details.  
