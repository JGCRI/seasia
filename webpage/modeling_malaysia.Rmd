...
data.frame(
  ...
  dplyr:: mutate("Files Used" = cell_spec(c("malaysia_elec_gen_pathway.xlsx",
                                            ...
                                            "malaysia_elec_hydro_ambitious_city.xmll"),
                                          "html", link=dt_url),
...
<p style='margin-left:1em;'>
1. Create a folder in the input directory eg. `./gcam-core/input/addons/malaysia`.
2. Download the example XML file ( [malaysia_elec_gen_low.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_gen_low.xml) and the subsidy link file [malaysia_elec_gen_link.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_gen_link.xml) to the folder. (Click on `Raw` and then `right-click` and select `save-as`.)
...
[malaysia_elec_hydro_low.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_hydro_low) to the folder. 
