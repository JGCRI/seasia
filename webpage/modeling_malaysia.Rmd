...
``` {r rchart-emiss-plot, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE, fig.height = 7}
...
```{r rchart-energy-my, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE, fig.width = 28, fig.height = 10, out.width = "100%"}
energy_my <- malaysia %>% 
  filter(param %in% energy_parameters,
         region == "All of Malaysia") %>%
  mutate(param = units) %>%
...
```{r rchart-elec-gen, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE, fig.height = 6}
...
```{r rchart-transport-mode, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE}
...
transport_m <- malaysia %>% 
  filter(param %in% transport_mode_params,
         region != "Malaysia") %>%
  mutate(param = units) %>%
  rchart::chart(folder = "rchart/transport/mode",
                save = F, 
                show = F,
                size_text = 10)
...
transport_f <- malaysia %>% 
  filter(param %in% transport_fuel_params,
         region != "Malaysia") %>%
  mutate(param = units) %>%
  rchart::chart(folder = "rchart/transport/fuel",
                save = F, 
                show = F,
                size_text = 10)
