...
dt_url <- c("https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/sectoral_policies/trn_ICE_low.xml",
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/sectoral_policies/trn_ICE_high.xml",
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/sectoral_policies/trn_ICE_ambitious_city.xml")

data.frame(
  Scenario = c("Low", "High", "Ambitious City")) %>% 
  dplyr:: mutate("Files Used" = cell_spec(c("trn_ICE_low.xml",
                                            "trn_ICE_high.xml",
                                            "trn_ICE_ambitious_city.xml"),
                                          "html", link=dt_url),
         Description = c("Phases liquids passenger vehicles out of the market by 2050",
...
data.frame(
  ...
  dplyr:: mutate("Files Used" = cell_spec(c("efficient_appliances_high.xml",
         ...
         Description = c("Increase prevelance of high-efficiency technologies (commercial and residential) through 2050",
                         ...
                         "Increase prevelance of high-efficiency technologies (commercial and residential) through 2050 in KL and 2070 in Rest of Malaysia")) %>% 
  kable("html", escape = FALSE, col.names = c("Scenario", "Files Used", "Description")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  row_spec(0, background = "#2A2A2A", color = "white")
...
data.frame(
  ...
  dplyr:: mutate("Files Used" = cell_spec(c("buildings_led_high.xml",
         ...
         Description = c("Gradually phases non-LED residential lighting technology out of the market by 2050",
                         ...
                         "Gradually phases non-LED residential lighting technology out of the market by 2050 in KL and 2070 in Rest of Malaysia")) %>% 
  kable("html", escape = FALSE, col.names = c("Scenario", "Files Used", "Description")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  row_spec(0, background = "#2A2A2A", color = "white")
...
data.frame(
  ...
  mutate(Description = c("Decreases shell conductance from 3.75 in 2020 to 0.487 (residential)/ 0.375 (commercial) in 2070 at an annual rate of 4% (residential)/ 4.5% (commercial)",
                         ...
                         "Follows the 'high' scenario trajectory in KL and the 'low' scenario trajectory for Rest of Malaysia")) %>%
  kable("html", escape = FALSE, col.names = c("Scenario", "Files Used", "Description")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  row_spec(0, background = "#2A2A2A", color = "white")
...
<p style='margin-left:1em;'>
1. Create a folder in the input directory: `./gcam-core/input/addons`.
2. Download the desired xml file (either [shell_eff_high.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/sectoral_policies/shell_eff_high.xml) or [shell_eff_low.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/sectoral_policies/shell_eff_low.xml)) to the folder.
...
data.frame(
  ...
  mutate(Description = c("Increases overall efficiency of industrial processes by 1% annually through 2070",
                         ...
                         "Increases overall efficiency of industrial processes by 1% annually through 2070 for KL and by 0.5% annually for Rest of Malaysia")) %>%
  kable("html", escape = FALSE, col.names = c("Scenario", "Files Used", "Description")) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive")) %>%
  row_spec(0, background = "#2A2A2A", color = "white")
```
...
data.frame(
  Scenario = c("All", "All", "Low", "Low", "High", "High", "Ambitious City", "Ambitious City")) %>% 
  dplyr:: mutate("Files Used" = cell_spec(c("elec_gen_pathway.xlsx",
                                            ...
                                            "elec_hydro_ambitious_city.xmll"),
                                          "html", link=dt_url),
...
data.frame(
  ...
  mutate(Description = c("CO2 emissions constraint for Malaysia (2035 - 2050)",
                         ...
                         "CO2 emissions constraint rest of the World (2050)",
