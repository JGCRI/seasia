...
This first chart will plot GDP, GDP per capita, and population with color-coded lines for each region.

```{r rchart-socio, message = FALSE}
...
``` {r rchart-elec}
elec <- c("elecConsumByDemandSectorTWh", "energyFinalConsumBySecEJ")
```
