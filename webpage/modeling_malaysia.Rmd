...
dt_url <- c("https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_trn_ICE_low.xml",
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_trn_ICE_high.xml",
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_trn_ICE_ambitious_city.xml")

data.frame(
  Scenario = c("Low", "High", "Ambitious City")) %>% 
  dplyr:: mutate("Files Used" = cell_spec(c("malaysia_trn_ICE_low.xml",
                                            "malaysia_trn_ICE_high.xml",
                                            "malaysia_trn_ICE_ambitious_city.xml"),
                                          "html", link=dt_url),
...
2. Download the desired ICE phase-out XML file (either [malaysia_trn_ICE_low.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_trn_ICE_low.xml), [malaysia_trn_ICE_high.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_trn_ICE_high.xml), or [malayisa_trn_ICE_ambitious_city.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_trn_ICE_ambitious_city.xml)) to the folder.
...
`<Value name = "scen">../input/addons/malaysia/malaysia_trn_ICE_low.xml</Value>`
</p>
</p>
...
dt_url <- c("https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/efficient_appliances_high.xml",
            ...
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/efficient_appliances_ambitious_city.xml")
...
2. Download the desired xml file (either [efficient_appliances_high.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/efficient_appliances_high.xml), [efficient_appliances_low.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/efficient_appliances_low.xml), or [efficient_appliances_ambitious_city.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/efficient_appliances_ambitious_city.xml) to the folder.
...
dt_url <- c("https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/buildings_led_high.xml",
            ...
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/buildings_led_ambitious_city.xml")
...
<p style='margin-left:1em;'>
1. Create a folder in the input directory: `./gcam-core/input/addons`.
2. Download the desired xml file (either [buildings_led_high.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/buildings_led_high.xml), [buildings_led_low.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/buildings_led_low.xml), or [buildings_led_ambitious_city.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/buildings_led_ambitious_city.xml)) to the folder.
...
dt_url <- c("https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/industry_aeei_high.xml",
            ...
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/industry_aeei_ambitious_city.xml")
...
<p style='margin-left:1em;'>
1. Create a folder in the input directory: `./gcam-core/input/addons`.
2. Download the desired industrial aeei xml file (either [industry_aeei_high.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/industry_aeei_high.xml), [industry_aeei_low.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/industry_aeei_low.xml), or [industry_aeei_ambitious_city.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/industry_aeei_low.xml)) to the folder.
...
dt_url <- c("https://github.com/JGCRI/seasia/blob/main/data/malaysia/malaysia_elec_gen_pathway.xlsx",
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_gen_link.xml",
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_gen_low.xml",
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_hydro_low.xml",
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_gen_high.xml",
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_hydro_high.xml",
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_gen_ambitious_city.xml",
            "https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_hydro_ambitious_city.xml")

data.frame(
  Scenario = c("All", "All", "Low", "Low", "High", "High", "Ambitious City", "Ambitious City")) %>% 
  dplyr:: mutate("Files Used" = cell_spec(c("malaysia_elec_gen_pathway.xlsx",
                                            "malaysia_elec_gen_link.xml",
                                            "malaysia_elec_gen_low.xml",
                                            "malaysia_elec_hydro_low.xml",
                                            "malaysia_elec_gen_high.xml",
                                            "malaysia_elec_hydro_high.xml",
                                            "malaysia_elec_gen_ambitious_city.xml",
                                            "malaysia_elec_gen_ambitious_city.xmll"),
                                          "html", link=dt_url),
...
<p style='margin-left:1em;'>
1. Create a folder in the input directory eg. `./gcam-core/input/addons/malaysia`.
2. Download the example XML files ( [malaysia_elec_gen_low.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_gen_low.xml) and [malaysia_elec_hydro_low.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_hydro_low)) as well as the subsidy link file [malaysia_elec_gen_link.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_elec_gen_link.xml) to the folder. (Click on `Raw` and then `right-click` and select `save-as`.)
...
5. To adjust the hydropower pathway, download the example XML file [malaysia_hydro_constraint_2030_KL.xml](https://github.com/JGCRI/seasia/blob/main/modeling/malaysia/malaysia_hydro_constraint_2030_KL.xml) to the folder. 
...
`<Value name = "scen">../input/addons/malaysia/malaysia_elec_gen_low.xml</Value>`
`<Value name = "scen">../input/addons/malaysia/malaysia_elec_hydro_low.xml</Value>`
`<Value name = "scen">../input/addons/malaysia/malaysia_elec_gen_link.xml</Value>`
