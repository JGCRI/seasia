...
ref_db <- "../data/malaysia/output/ref_db"
high_db <- "../data/malaysia/output/high_db"
high_cn_db <- "../data/malaysia/output/high_cn_db"

paths <- c(ref_db, high_db, high_cn_db)
names(paths) <- c("ref", "high", "high_carbon_neutral")

# Choose parameters of interest
params <- c("elecByTechTWh", "elecConsumByDemandSectorTWh", "emissCO2BySectorNoBio",
            "emissGHGBySectorGWPAR5", "emissGHGByGasGWPAR5", "energyFinalByFuelEJ", 
            "energyFinalConsumBySecEJ", "gdp", "gdpPerCapita", "pop", 
            "energyPrimaryByFuelEJ", "energyFinalSubsecBySectorBuildEJ", 
            "energyFinalSubsecByFuelBuildEJ", "energyFinalSubsecByFuelIndusEJ", 
...
for(p in paths){
  gcamextractor::readgcam(gcamdatabase = p,
                          ...
                          paramsSelect = params,
                          folder = paste0("./gcamextractor/", names(paths)[]))
}
...
malaysia_emissions <- bind_rows(co2, ghg) %>%
  mutate(class = case_when(grepl("International",class)~"transport",
...
```{r rchart-building-my, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE, fig.width = 8, fig.height = 6, out.width = "100%"}
...
```{r rchart-building-kl, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE, fig.width = 8, fig.height = 6, out.width = "100%"}
