...
``` {r rchart-emiss-gas-scenario-plot-my, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE, out.width = "100%"}

gas_sce_my <- my_emissions_gas %>%
  rchart::chart(save = F, 
                show = F,
                scenRef = "Ref",
...
``` {r rchart-emiss-gas-scenario-plot-kl, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE}

gas_sce_kl <- kl_emissions_gas %>%
  rchart::chart(save = F, 
                show = F,
                scenRef = "Ref",
                summary_line = T,
...
``` {r rchart-gas-plot-kl, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE, fig.width = 10, fig.height = 6, out.width = "100%"}
...
```{r rchart-elec-gen-sce-my, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE}
...
```{r rchart-building-sce-my, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE}
...
```{r rchart-transport-kl-mode, results = 'hide', eval = TRUE, echo = TRUE, warning = FALSE, error = FALSE, message = FALSE}
...
<!-------------------------->
## Validation of GCAM outputs {.tabset}
<!-------------------------->
***
