...
<p style='margin-left:1em;'>
To represent a transition to public transportation, we adjust the shareweights of public transportation modes (Bus, Rail, Walk, and Cycle) in Kuala Lumpur and the Rest of Malaysia in order to increase their share in the market. Representing a modal shift in GCAM involves guessing and checking- that is, changing the shareweights, running the model, checking the output, and fine-tuning from there.
</p>
