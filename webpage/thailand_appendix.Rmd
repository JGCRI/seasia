...
<!-- capacity_factors <- read.csv("../data/Thailand/scenario_inputs/1_National_policies/capacity_factors.csv", fileEncoding="UTF-8-BOM")  -->

<!-- elec_gen <- dplyr::full_join(capacity, capacity_factors) %>%  -->
<!--   mutate(generation = value*capacity_factor*8760*MWh_to_EJ, -->
<!--          units = "EJ") %>%  -->
<!--   select(!c(value, capacity_factor)) %>% rename(value = generation) -->
