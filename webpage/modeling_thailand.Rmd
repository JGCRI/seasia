...
dt_url <- c("https://github.com/JGCRI/seasia/blob/main/modeling/thailand/FILENAME_1",
            "https://github.com/JGCRI/seasia/blob/main/modeling/thailand/FILENAME_2")
...
data.frame(
  Scenario = c("SCENARIO_NAME_1", "SCENARIO_NAME_2")) %>% 
  mutate("Files Used" = cell_spec( c("FILENAME_1",
                                     "FILENAME_2"),
                                   "html", link = dt_url)) %>% 
  mutate(Description = c("DESCRIPTION OF FILE 1",
...
<p style='margin-left:1em;'>
<!---description of the approach goes here--->
...
<p style='margin-left:1em;'>
BACKGROUND INFORMATION ABOUT EMISSIONS CONSTRAINTS, INCLUDING LINK(S) TO RELEVANT PARTS OF GCAM DOCUMENTATION
</p>
</span>
</div>
...
2. Download the emissions constraint xml file(s) [FILENAME_1](LINK_TO_FILE_1) and [FILENAME_2](LINK_TO_FILE_2)) to the folder.
<!---add description of customization--->
4. DESCRIBE HOW TO CHANGE RELEVANT PARAMETERS (I.E. NET-ZERO YEAR, etc.)
5. Save the xml files and then point to them in your configuration file by adding the line: 
</p>
<p style='font-size:0.8em'>
<!---insert exmaple XML filenames--->
`<Value name = "scen">../input/addons/thailand/FILENAME_1</Value>`
`<Value name = "scen">../input/addons/thailand/FILENAME_2</Value>`
</p>
</p>
